...
#	Description:  V2Board专属v2rayPoseidon一键部署 + BBR+BBR魔改版+BBRplus+Lotserver自助安装脚本
#	Version: 1.3.2
#	Author: 本脚本基于 千影,cx9208 bbr脚本进行修改
#=================================================
...
installv2(){
	if [[ "${release}" == "centos" ]]; then
		echo '升级内核安装必要支持及安装V2ray Poseidon程序开始....'
		echo '.....'
		echo '升级系统内核并安装必要支持中....'
		echo '时间较长,请耐心等待'
		echo '...'
		...
		echo '同步机器时间中'
		echo '机器时间已同步,请检查机器时间与本地是否有误差.'
		date
		echo '..'
		echo '...'	
	elif [[ "${release}" == "debian" || "${release}" == "ubuntu" ]]; then
		apt-get update -y && apt-get install wget curl unzip -y
		echo '升级内核安装必要支持及安装V2ray Poseidon程序开始....'
		echo '.....'
		echo '升级系统安装必要支持中......'
		echo ''
	...
	echo '安装V2ray Poseidon开始.....'
	echo ''
	echo '安装v2ray Poseidon.....'
